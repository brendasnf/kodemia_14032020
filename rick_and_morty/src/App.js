...
class App extends React.Component {
  ...
  activarModal(id) {
    api.getAllCharactersId(id).then(personaje =>
      this.setState({
        modalActivo: true,
  ...
  renderCards(p) {
    return (
      <div key={p.id} className='Card' onClick={p => this.activarModal(p.id)}>
              ...
              <div className='Card-detalle'>
                ...
                <div className='Card-detalle-descripcion'>
                  <div className='descripcion'>
                    <h3>Name</h3>
                    <div className='caracteristica-valor'>
                      <p>Status</p>
                      <p className='caracteristica-valor'>
                        {this.state.personajeSelecionado}
                      </p>
                    </div>
